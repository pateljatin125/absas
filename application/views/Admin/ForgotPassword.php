        ...
        <div class="login-container lightmode">
            ...
            <div class="login-box animated fadeInDown">
                <div class="login-logo" style="margin-top: 70px;"><a href="<?php echo base_url('/AdminLogin/'); ?>">
                    ...
                    <h2 style="color:white;">Mypolice</h2>
                    </a></div>
                <div class="login-body">
                    <div class="login-title"><strong>Forgot Password</strong></strong> to your account</div>
					<div class="alert alert-danger" role="alert" id="error" style="display: none;">...</div>
                    <form id="login-form1" name="login_form1" role="form" class="form-horizontal" method="post">
					<input type="hidden" id="base_url" value="<?php echo base_url();?>">
                    <div class="form-group">
                        <div class="col-md-12">
                            <input type="email" class="form-control" placeholder=" Enter E-mail Address" name="username" id="username" tabindex="1"  />
                        </div>
