        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title"><strong>MANAGE All Verified User' </strong></h3>
                        ...
                        foreach ($result_new as $itm) { ?>
                          <tr id="user<?php echo $itm->user_id; ?>">
                            ...
                            <td>
                              ...
                              <a href="<?php echo base_url('/ViewSOS/'); ?><?php echo $itm->user_id; ?>">SOS/</a>
                              <a href="<?php echo base_url('/ViewFieldReport/'); ?><?php echo $itm->user_id; ?>">Filed Report </a>
