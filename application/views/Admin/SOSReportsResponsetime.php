                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default" style="box-shadow:none">
                        <div class="panel-heading col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="panel-title"><strong>SOS Reports by Response time </strong></h3>
                                </div>
                                        ...
                                        <div role="tabpanel" class="tab-pane fade active in" id="sos" aria-labelledby="sos-tab">
                                            ...
                                            <table id="customers2" class="table datatable">
                                                ...
                                                <tbody>
                                                    ...
                                                    $count = 1;
                                                    if (!empty($resultsos)) {
                                                        foreach ($resultsos as $rsnew) {
                                                            echo '<tr class="">';
                                                            echo '<td>' . $count . '</td>';
                                                            echo '<td>' . $rsnew['SOS_id'] . '</td>';
                                                            echo '<td>' . $State . '</td>';
                                                            echo '<td>' . $rsnew['created_at'] . '</td>';
                                                            $from_time = $rsnew['created_at'];
                                                            $to_time = date('Y/d/m h:i:s a', strtotime($rsnew['update_at']));
                                                            $diff = strtotime($to_time) - strtotime($from_time);
                                                            // echo date('H:i:s', $diff);
                                                            echo '<td>' . strtoupper(date('Y/d/m h:i:s a', strtotime($rsnew['update_at']))) . '</td>';
