  ...
  <?php } ?>    
    ...
    <ul id="myTab" class="nav nav-tabs" role="tablist">
      <li role="presentation" class="active" style="margin-left: -5px;"><a href="#Popularity" id="Popularity-tab" role="tab" data-toggle="tab" aria-controls="Popularity" aria-expanded="true">iWitness</a></li>
