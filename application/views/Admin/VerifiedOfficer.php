        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title"><strong>MANAGE All Verified Officer's </strong></h3>
                        ...
                        foreach ($result_new as $itm) { ?>
                          <tr id="Officer<?php echo $itm->Officer_id; ?>">
                            ...
                            <td>
                              ...
                              <a href="<?php echo base_url('/ViewSOS/'); ?><?php echo $itm->Officer_id; ?>">/SOS/</a>
                              <a href="<?php echo base_url('/ViewFieldReport/'); ?><?php echo $itm->Officer_id; ?>">Filed Report </a>
                            </td>
                          </tr>
                        <?php $count++;
                        }
