                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>MANAGE All User Logs </strong></h3>
                                        ...
                                        <table id="customers2" class="table datatable">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($result_new as $itm) { ?>
                                                    <tr class="user_<?php echo $itm->user_id; ?>" id="log_<?php echo $itm->log_id; ?>">
                                                        ...
                                                        <td>
                                                            <a href="#" class="user_<?php echo $itm->user_id; ?>" data-toggle="modal" data-target="#exampleModal" onclick="return viewLog(<?php echo $itm->log_id; ?>)">View</a>
                                                            <?php if ($itm->is_login == 0) { ?>
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">User Log Details
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button></h5>
                                </div>
