                            ...
                            <form id="update-settings" action="<?php  echo base_url()."update-settings"; ?>" role="form" class="form-horizontal" method="POST" >
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row" style="margin-bottom:30px">
                                        <div class="col-md-6">
                                            <input type="hidden" name="tblSno" value="<?php echo $AppAgency[0]['id']; ?>">
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">State Name</label>
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" class="form-control" name="stateName" id="state_name" value="<?php echo $AppAgency[0]['name']; ?>" required/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
