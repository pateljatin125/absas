       ...
       * element that contains the map. */
                                            ...
                                            <script>
                                                function initMap() {
                                                    ...
                                                    //var markers =[['29', 40.671531, -73.963588],['29', 40.672587, -73.968146],['29', 40.665588, -73.965336]];
                                                    console.log(markers);
                                                    //console.log(markers);        
                                                    // Info window content
                                                    //var infoWindowContent = [["<div class='info_content'><h3>14\/Sid<\/h3><p>Sitaphalmandi, Warasiguda, Secunderabad, Telangana 500061, India<\/p><\/div>"],["<div class='info_content'><h3>35\/Srinivas<\/h3><p>Rd Number 1, Sivaganga Colony, L. B. Nagar, Hyderabad, Telangana 500074, India<\/p><\/div>"],["<div class='info_content'><h3>35\/Srinivas<\/h3><p>Rd Number 1, Sivaganga Colony, L. B. Nagar, Hyderabad, Telangana 500074, India<\/p><\/div>"],["<div class='info_content'><h3>35\/Srinivas<\/h3><p>Rd Number 1, Sivaganga Colony, L. B. Nagar, Hyderabad, Telangana 500074, India<\/p><\/div>"],["<div class='info_content'><h3>35\/Srinivas<\/h3><p>Rd Number 1, Sivaganga Colony, L. B. Nagar, Hyderabad, Telangana 500074, India<\/p><\/div>"]];
                        ...
                        <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Search Crime Map by Category
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button></h5>
                                    </div>
