                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Manage Wanted Persons </strong></h3>
                            ...
                            <div class="btn-group pull-right">
                                <button class="btn btn-danger dropdown-toggle" data-toggle="modal" data-target="#exampleModal2"><i class="fa fa-bars"></i>Create Wanted Persons</button>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Create Wanted Persons
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button></h5>
                                        </div>
                                        <form id="create-form" action="<?php echo base_url('WantedPersonssAdd'); ?>" role="form" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-9">
                                                                                <div class="input-group">
                                                                                    <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                                                    <input type="text" class="form-control" name="Crime_Committed" id="Crime_Committed" required />
...
<li class=""><a href="#tab3" data-toggle="tab" aria-expanded="false">Javascript</a></li>
                                        ...
                                        <table id="customers2" class="table datatable">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($result as $itm) { ?>
                                                    <tr class='' id="wanted<?php echo $itm['WantedPerson_id']; ?>">
                                                        <td><?php echo $count; ?>.</td>
                                                        <td><?php echo $itm['WantedPerson_id']; ?></td>
                                                        <td><?php echo $itm['Full_Name']; ?></td>
                                                        <td><?php echo $itm['Age']; ?></td>
                                                        <td><?php echo $itm['Sex']; ?></td>
                                                        <td><?php echo $itm['Spoken_Language']; ?></td>
                                                        <td id="status_<?php echo $itm["WantedPerson_id"]; ?>"><?php if ($itm['WantedPerson_status'] == 1) { ?><a href="javascript:void(0);" onclick="changeBannerStatus(0,<?php echo $itm["WantedPerson_id"]; ?>);"><img src="<?php echo base_url(); ?>images/bullet_green.png" width="32" height="32" title="click to deactive this SOS." /></a><?php } else { ?><a href="javascript:void(0);" onclick="changeBannerStatus(1,<?php echo $itm["WantedPerson_id"]; ?>);"><img src="<?php echo base_url(); ?>images/bullet_red.png" width="32" height="32" title="click to Aeactive this SOS." /> </a><?php } ?></td>


                                                        <td>
                                                            <!--<a href="<?php echo base_url('/EditNewsArticles/'); ?><?php echo $itm['WantedPerson_id']; ?>">Edit</a>/-->
                                                            <a href="#" data-toggle="modal" data-target="#exampleModal1" onclick="return Wantedupdate(<?php echo $itm["WantedPerson_id"]; ?>)">Edit/</a>

                                                            <a href="javascript:void(0)"><span onClick="return doconfirm(<?php echo $itm['WantedPerson_id']; ?>);">Delete/</span></a>
                                                            <a href="#" data-toggle="modal" data-target="#exampleModal" onclick="return Wantedview(<?php echo $itm["WantedPerson_id"]; ?>)">View</a>
                                                        </td>
                                                    </tr>
                                                <?php $count++;
                                                }
                    ...
                    <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Update Wanted Persons
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button></h5>
                                </div>
                                <form id="" action="<?php echo base_url('WantedPersonsUpdate'); ?>" role="form" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                    <div class="modal-body">
                                        <div class="col-md-12 mt-3" style="padding:30px 15px; background:#fff">
                                            <div class="row">
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Wanted Persons Details
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button></h5>
                                </div>
    ...
    <script>
        ...
        function Wantedview(WantedPerson_id) {

            //alert(WantedPerson_id);

            var base_url = $('#base_url').val();
            var datastring = 'id=' + WantedPerson_id;

            //alert(datastring);
            //alert(base_url);
            $.ajax({
                url: base_url + 'Admin/WantedPersonsview',
                method: 'POST',
                data: datastring,
        ...
        function Wantedupdate(WantedPerson_id) {

            var base_url = $('#base_url').val();
            var datastring = 'WantedPerson_id=' + WantedPerson_id;

            //alert(datastring);
            //alert(base_url);
            $.ajax({
                url: base_url + 'Admin/WantedPersonsedit',
                method: 'POST',
                data: datastring,
                success: function(response) {
        ...
        function doconfirm(id) {
            ...
            //alert(datastring);
            $.ajax({
                url: base_url + 'Admin/WantedPersonsdel',
                method: 'POST',
                data: datastring,
        ...
        function changeBannerStatus(status, event_id) {
            ...
            //alert(base_url);
            $.ajax({
                url: base_url + 'Admin/WantedPersonsstatus',
                method: 'POST',
                data: datastring,
                success: function(data) {
                    //alert(data);
